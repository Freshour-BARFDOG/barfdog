...
export default function SearchUserPopup() {
  ...
  //       confirm(
  //         `선택된 ${selectedMemberIdList.length}명의 회원을 추가 하시겠습니까?`,
  //       )
  //     ) {
  ...
  const valid_allCheckboxesChecked = () => {
    if (!Array.isArray(itemList) || !Array.isArray(selectedMemberIdList))
      return;
  ...
  return (
    <>
      <MetaTitle title="구독취소 사유" />
      <div id={s.popup}>
        <PopupWrapper style={{ width: 820 }}>
          <header className={s.header}>
            <div className={s.row}>
              <div className={s.cont}>
                <h1 className={s['popup-title']}>구독취소 사유</h1>
