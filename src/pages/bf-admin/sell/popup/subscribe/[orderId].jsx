              ...
              <section className={s.table}>
                <ul>
                  <li className={s['table-list']}>
                    <ProductInfo_naverpay
                      data={{
                        ...data.subscribePaymentDto,
                  ...
                  <li className={s['table-list']}>
                    <ProductInfo_iamport
                      data={{ impUid: data.subscribePaymentDto.impUid }}
                    />
                  </li>
                  <li className={s['table-list']}>
                    <ProductInfo_basicOrderInfo
                      basicOrderInfo={data.subscribeOrderInfoDto}
                    />
                  </li>
                  ...
                  <li className={s['table-list']}>
                    <ProductInfo_payment
                      paymentInfo={data.subscribePaymentDto}
                    />
                  </li>
                  <li className={s['table-list']}>
  ...
  if (res?.data) {
    ...
    DATA = {
      ...
      subscribeDeliveryDto: {
        ...
        deliveryCode: data.subscribeDeliveryDto.deliveryCode,
