...
function CreateRewardPage() {
 const router = useRouter();
  ...
  const ProductCategory_SUBSCRIBE = 'SUBSCRIBE';
  const ProductCategory_NORMAL = "NORMAL";
  const [productCategory, setProductCategory] = useState('');

  const onProductCategorySelectHandler = (value) => {
    const val = value;
              ...
              {productCategory && (
                <>
                  ...
                  <li className="cont_divider">
                    <div className="input_row">
                      <div className="title_section fixedHeight">
                        <label className="title">유저 이름</label>
                      </div>
                      <div className="inp_section">
                        <div className="inp_box">
                          <input
                  ...
                  <li className={s.btn}>
                    <div className={s.flex}>
                      <div className={s.left_btn} onClick={returnToPrevPage}>
                        취소
                      </div>
