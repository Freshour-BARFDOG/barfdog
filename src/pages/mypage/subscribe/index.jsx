                      ...
                      <div className={s.flex_box}>
                        ...
                        <div className={s.grid}>
                          ...
                          <div className={s.col_4}>
                            <Link href={`/mypage/subscribe/${item.subscribeDto.subscribeId}`} passHref>
                              <a className={s.btn}>관리하기</a>
                            </Link>
                          </div>
                        </div>
                      </div>
      ...
      querySubscribesDtoList: [
        {
          subscribeDto: {
            subscribeId: 2924,
            pictureUrl: 'https://images.unsplash.com/photo-1537151625747-768eb6cf92b2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=685&q=80',
            skipCount: 0,
            dogName: '몽몽이',
            plan: 'HALF',
        ...
        },
        {
          subscribeDto: {
            subscribeId: 2936,
            pictureUrl: 'https://images.unsplash.com/photo-1588943211346-0908a1fb0b01?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80',
            skipCount: 3,
            dogName: '슈',
            plan: 'FULL',
        ...
        },
        {
          subscribeDto: {
            subscribeId: 2948,
            pictureUrl: 'https://images.unsplash.com/photo-1576201836106-db1758fd1c97?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80',
            skipCount: 0,
            dogName: '몽실이',
            plan: 'TOPPING',
