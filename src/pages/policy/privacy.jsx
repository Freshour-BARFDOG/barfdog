      ...
      <Wrapper>
        <div className={Styles.inner}>
          ...
          <div className={Styles.content}>
            ...
            기념일 , 법정대리인정보 , 주민등록번호 , 서비스 이용기록 , 접속 로그
            , 접속 IP 정보 , 결제기록
            <br />
            ...
            <br />
            1. 사이트 회원 가입 및 관리 : 회원가입시 본인여부 확인,서비스 이용
            및 상담,공지사항 전달 , SNS 및 제 3자 계정을 연계하여 간편로그인
            서비스 제공
            <br />
            ...
            *진행하는 이벤트에 따라 수집 항목이 상이할 수 있으므로 응모 시 별도
            ...
            <br />
            <br />
            <strong>■ 제3자에 대한 제공 및 수집한 개인정보의 위탁 </strong>
            <br />
            • 1. 회사는 고객의 개인정보를 &#8216;개인정보의 수집 및
            ...
            <br />
            (다) 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우상기사항에
            의해 개인정보를 제공하는 경우에도 본래의 수집∙이용 목적에 반하여
            무분별하게 정보가 제공되지 않도록 최대한 노력하겠으며 보다 나은
            서비스 제공, 고객편의 제공 등 원활한 업무 수행을 위하여 아래와 같이
            ...
            <ul>
              ...
              <li>상품 배송추적: 우체국, 대한통운</li>
              <li>주문 상품의 배송: 우체국, 대한통운</li>
              <li>결제 및 에스크로 서비스: kcp</li>
            </ul>
            <br />
            ※ 수탁자에 공유되는 정보는 당해 목적을 달성하기 위하여 필요한
            최소한의 정보에 국한됩니다. 또한 고객의 서비스 요청에 따라 해당하는
            업체에 선택적으로 개인정보가 제공되고 있습니다.
            <br />
            ...
            <br />
            <br />
            <strong>■ 14세 미만 아동의 개인정보보호</strong>
            <br />
            회사는 법정대리인의 동의가 필요한 만 14세 미만 아동의 회원가입은
            받고 있지 않습니다.
            <br />
            <br />
            <strong>
            ...
            <br />
            <br />
            <strong>■ 개인정보처리방침의 개정과 그 공지</strong>
            <br />
            본 개인정보 처리방침을 개정할 경우에는 최소 7일전에 홈페이지 또는
            이메일을 통해 변경 및 내용 등을 공지하도록 하겠습니다. 다만이용자의
            소중한 권리 또는 의무에 중요한 내용 변경이 발생하는 경우
            시행일로부터 최소 30일 전에 공지하도록 하겠습니다.
            <br />
            <br />
            개인정보관리책임자 성명 : 임경호
            <br />
            ...
            <br /> 회사는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴
            것입니다.
            <br />
