              ...
              <div className={Styles.right_box}>
                ...
                <div className={Styles.mid_box}>
                  ...
                  <div>
                    ...
                    않는 것이 좋습니다. 아이들이 처음 생식을 먹는 단계에서
                    소화에 부담없이 적응할 수 있도록 흰살고기 칠면조와 닭고기를
                    활용한 완벽한 비율의 스타트 프리미엄을 이용해보세요.
                  </div>
          ...
          <div className={Styles.content_box}>
            <div className={Styles.left_box}>
              ...
              <div className={Styles.last_contain}>
                ...
                <br />
                <br />
                따라서 각 바프독 레시피가 가지고 있는 장점을 골고루 섭취하기
                위해 정기구독 서비스로 반려견 친구들이 다양한 영양을 골고루
                섭취할 수 있도록 다양한 레시피를 급여하시기를 추천드립니다.
              </div>
            </div>
            <div className={Styles.right_box}>
              <div className={`${Styles.image} img-wrap`}>
