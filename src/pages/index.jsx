...
// import Mainbanner from '/public/img/main_banner.svg';
    ...
    <Layout>
        ...
        <SwiperSlide>
          <section className={Styles.banner}>
              <div className ={Styles.inner}>
                <Link href = "/" passHref>
                  {/* <a><Mainbanner /></a> */}
                  <a><Image src={Mainbanner} objectFit='cover' layout='fill' alt='' ></Image></a>
                </Link>          
              </div> {/* inner end */}
          </section>
        </SwiperSlide>
        ...
        <section className={Styles.recipe_info}>
          <div className ={Styles.inner}>
            ...
            <div className={Styles.starter_banner}>
              ...
              <div className={Styles.box}>
                <div className={Styles.firstbox}>
                  <Image src = {StartBanner} objectFit='cover' layout="fill" alt='' ></Image>
                </div>
            ...
            <div className={Styles.box22}>
              <div className={Styles.btnbox}>
                  <Link href = "/" passHref>
                    <a><Image src = {SubscribeBtn} objectFit='cover' layout="fill" alt='' /> </a>
                  </Link>
              </div>
            </div>
        ...
        <section className={Styles.barfraw}>
          <div className ={Styles.inner}>
            ...
            <div className={Styles.rightbox}>
              <p>ABOUT BARF</p>
              <h1>바프생식이란?</h1>
              <h3 className="font-NotoSans"> BARF(Biologi cally Appropriate Raw Food)는 생물학적으로 
              적절한 생식이라는 뜻으로, 생고기와 뼈, 야채를 적절히 배합하여
              반려동물에게 단백질과 지방을 신선한 상태에서 섭취할 수 있도록
              돕습니다. 바프독은 70%의 두 종류 고기와 칼슘이 풍부한 뼈, 내장,
              신선한 야채를 배합해 완벽한 비율의 영양을 공급합니다.</h3>
            </div>
          </div> {/* inner end */}
        </section>
      </Wrapper>
      ...
      <Wrapper>
        <section className={Styles.barfgood}>
          <div className={Styles.inner}>
            <div className={Styles.leftbox}>
              <h1>생식을 하면<br />어떤점이 바뀔까요?</h1>
              <p>
              BARF(Biologi cally Appropriate Raw Food)는 생물학적으로 적절한 생식이라는 뜻으로, 생고기와 뼈, 야채를 적절히 배합하여 반려동물에게 단백질과 지방을 신선한 상태에서 섭취할 수 있도록 돕습니다. 바프독은 70%의 두 종류 고기와 칼슘이 풍부한 뼈, 내장, 신선한 야채를 배합해 완벽한 비율의 영양을 공급합니다.
              </p>
            </div>
            <div className={Styles.rightbox}>
              <div>
        ...
        <section className={Styles.difference2}>
          ...
          <ul>
            <li className={Styles.firstbox}>
              <p className={Styles.title}>완벽한 영양구성<br />real BARF</p>
                <Image src = {LeftPic} alt='' />
              <p className={Styles.text}>생고기, 칼슘이 풍부한 뼈, 신선한 야채를 완벽한 비율로 구성해 반려견이 필요한 영양분을 골고루 섭취 할 수 있습니다.</p>
            </li>

            <li className={Styles.midbox}>
              <p className={Styles.title}>국내최초 국내유일<br />double meats</p>
                <Image src = {midPic} alt='' />
              <p className={Styles.text}>전문가들은 균형잡힌 식사를 위해 한끼에 두가지 이상의 고기를 섭취하도록 권장합니다. 바프독은 모든 레시피에 두가지 고기를 풍부하게 담았습니다.</p>
            </li>

            <li className={Styles.firstbox}>
              <p className={Styles.title}>미국사료협회 영양기준<br />AAFCO</p>
                <Image src = {rightPic} alt='' />
              <p className={Styles.text}>미국 사료협회 AAFCO에서 제시한 펫푸드 영양성분 가이드라인을 충족하며 고단백, 고영양의 프리미엄 맞춤형 생식을 제공합니다.</p>
            </li>
          </ul>
        </section>
      </Wrapper>
          ...
          <div className={`${Styles.inner} clearfix`}>
            <div className={`${Styles['cont-left']} cont-left`}>
              <div className={Styles.title_section}>
                <h2 className={Styles.title}>혹시 이런 고민 해본적 있으신가요?</h2>
                <p className={Styles.subtitle}>생고기, 칼슘이 풍부한 뼈, 신선한 야채를 완벽한 비율으로 구성해 반려견이 필요한 영양분을 골고루 섭취할 수 있습니다.완벽한 비율으로 구성해 반려견이 필요한 영양분을 골고루섭취할 수 있습니다.완벽한 비율으로</p>
                <button type="button" className={`${Styles.btn_main}`}>바프생식 둘러보기</button>
              </div>
            </div>
                  ...
                  <li>
                    <div className={Styles.card}>
                      <div className={`${Styles['img-wrap']} img-wrap`}>
                        <Image src ={require('/public/img/pages/home/home_clientWorry.png')} objectFit='cover' layout="fill" alt='카드 이미지' />
                      </div>
                      <p className={Styles.card_title}>견주님의 고민</p>
                      <div className={Styles.details}>
                        <ul>
                          <li>생식을 시도하고 싶지만 공부해야할 것이 많아 확신이 서지 않고, 반려견의 적응이 두려워요</li>
                          <li>기존 화식이나 건식사료를 급여 중 건강이 나빠진 반려견을 위해서 생식을 시도해보고싶어요</li>
                          <li>생식을 시도하고 싶지만 공부해야할 것이 많아 확신이 서지 않고, 반려견의 적응이 두려워요</li>
                          <li>생식을 시도하고 싶지만 공부해야할 것이 많아 확신이 서지 않고, 반려견의 적응이 두려워요</li>
                        </ul>
                      </div>
      ...
      <Wrapper bgColor='#F9F2EC'>
        <section className={Styles.difference5}>
          <div className={Styles.inner}>
            <h2 className={Styles.title}>수많은 후기가 증명하는
BARFDOG</h2>
