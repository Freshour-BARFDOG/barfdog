...
const Modal_policy = ({ modalState, setModalState }) => {
  const onModalHide = () => {
    setModalState(false);
  };
  ...
  return (
    ...
    >
      ...
      <header className={s['title-section']}>
        <h3 className={s.title}>개인정보처리방침</h3>
      </header>
      <section className={'body'}>
        <ScrollContainer className={s.scrollContainer} height={417} scrollBarWidth={'8'}>
          ...
          <br />
          <i className={s['indent-1']} />- 회사의 서비스 이용 과정에서 서비스 이용기록, 방문기록,
          불량 이용기록, IP 주소, 쿠키, 광고식별자 등의 정보가 자동으로 생성되어 수집될 수 있습니다.
          <br />
          <i className={s['indent-1']} />- 진행하는 이벤트에 따라 수집 항목이 상이할 수 있으므로
          ...
          ο 파기절차
          <br />
          <i className={s['indent-1']} />- 회원님이 회원가입 등을 위해 입력하신 정보는 목적이 달성된
          후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한
          정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어집니다.
          <br />
          <i className={s['indent-1']} />- 별도 DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는
          보유되어지는 이외의 다른 목적으로 이용되지 않습니다.
          <br />
          ο 파기방법
          <br />
          <i className={s['indent-1']} />- 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는
          기술적 방법을 사용하여 삭제합니다.
          <br />
          <p>■ 개인정보 제공</p>
          ...
          예외로 합니다.
          <br />
          <i className={s['indent-1']} />- 이용자들이 사전에 동의한 경우
          <br />
          <i className={s['indent-1']} />- 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진
          ...
          제공하는 경우에도 본래의 수집∙이용 목적에 반하여 무분별하게 정보가 제공되지 않도록 최대한
          노력하겠으며 보다 나은 서비스 제공, 고객편의 제공 등 원활한 업무 수행을 위하여 아래와 같이
          개인정보 처리 업무를 외부 전문업체에 위탁하여 운영하고 있습니다.
          <br />
          <i className={s['indent-1']} />- 위탁업무 내용 및 수탁자
          <br />
          <i className={`${s['indent-2']} ${s['deco-square']}`} />
          ...
          <br />
          <p>
            <i className={`${s['deco-triangle']}`} /> 쿠키 등 사용 목적
          </p>
