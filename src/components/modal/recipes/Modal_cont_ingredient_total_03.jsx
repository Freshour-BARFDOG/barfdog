    ...
    <div data-modal-type="duckAndLamb">
      <div className={s.modal_text_box4}>
        <p className={s.text_row_1}>
          양어깨살(뉴질랜드 방목 유기농 LAMB), 통오리(국내산 무항생제),
          오리정육(국내산 무항생제), 오리근위(국내산 무항생제), 닭간(국내산),
          소비장(국내산), 소신장(국내산), 단호박(국내산), 당근(국내산),
          양배추(국내산), 콜리플라워(국내산), 그린빈(벨기에), 애호박(국내산),
          케일(국내산), 사과(국내산), 녹색바나나(필리핀), 난황(국내산),
          표고버섯(국내산), 브로콜리(국내산), 딸기(국내산), 블루베리(미국산),
          밀싹(국내산), 치아씨드(USDA 유기농 인증 미국산), 아마씨드(USDA 유기농
          인증 미국산), 대구간유(USDA 유기농 인증 미국산), 코코넛오일(USDA
          유기농 인증 미국산), 강황(USDA 유기농 인증 미국산/인도산), 켈프(USDA
          유기농 인증 미국산), 스피루리나(USDA 유기농 인증 미국산),
          실리엄허스크(미국산), 요오드화소금(미국산), 비타민E(미국산),
