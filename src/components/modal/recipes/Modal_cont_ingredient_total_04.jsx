    ...
    <div data-modal-type="lambAndBeef">
      <div className={s.modal_text_box4}>
        <p className={s.text_row_1}>
          양어깨살(뉴질랜드산 방목 유기농 LAMB), 소보섭살(풀먹은 호주산 방목 유기농), 소사태살(풀먹은 호주산 방목 유기농),
          양목뼈(호주산 무항생제/뉴질랜드산 방목 유기농LAMB), 소간(국내산), 소비장(국내산), 소신장(국내산),
          당근(유기농 국내산), 양배추(유기농 국내산), 콜리플라워(국내산), 파프리카(국내산), 애호박(국내산),
          케일(국내산), 사과(충주 국내산), 표고버섯(국내산), 브로콜리(유기농 국내산),
          블루베리(미국산), 단호박(유기농 국내산), 커티지치즈(국내산), 대구간유(노르웨이산),
          햄프씨드(USDA 유기농인증 미국산), 치아씨드(USDA 유기농인증 미국산), 호박씨(USDA 유기농인증 미국산),
          켈프(USDA 유기농인증 미국산), 스피루리나(USDA 유기농인증 미국산), 코코넛오일(USDA 유기농 인증 미국산)
        </p>
