    ...
    <div data-modal-type="starterPremium">
      <div className={s.modal_text_box4}>
        <p className={s.text_row_1}>
          닭가슴살(국내산 무항생제), 닭다리살(국내산 무항생제), 칠면조가슴살(칠레산), 통닭(국내산 무항생제), 닭간(국내산), 소지라(국내산), 소신장(국내산), 당근(유기농 국내산), 양배추(유기농 국내산), 콜리플라워(국내산),애호박(국내산), 표고버섯(국내산), 블루베리(미국산), 단호박(유기농 국내산), 커티지치즈(국내산), 난황(동물복지 유정란), 벌꿀(지리산 천연 벌꿀 국내산), 저염멸치(국내산), 대구간유(노르웨이산), 햄프씨드(USDA 유기농인증 미국산), 치아씨드(USDA 유기농인증 미국산), 해바라기씨유(NON-GMO 유기농 이탈리아산), 켈프(USDA 유기농인증 미국산), 코코넛오일(USDA 유기농인증 미국산)
        </p>
