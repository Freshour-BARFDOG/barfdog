    ...
    <div className={Styles.swiper_main_outerWrap}>
      ...
      <Swiper
        ...
        onInit={(swiper) => {
          ...
          swiper.params.pagination.el.classList.add( 'swiper-pagination__mainSection' );
          swiper.params.pagination.el.classList.add( Styles['swiper-pagination__mainSection'] );
      ...
      >
        {arrangedData?.length > 0 && arrangedData?.map( (d, index) => (
