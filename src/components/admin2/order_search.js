...
const statusSubscribe = [
  ...
  { label: '구독전', value: 'BEFORE_PAYMENT' },
  { label: '구독보류', value: 'SUBSCRIBE_PENDING' },
  { label: '설문완료', value: 'SURVEY_COMPLETED' },
  { label: '구독취소', value: 'SUBSCRIBE_CANCEL' },
  ...
  return (
    <Form onFinish={onFinish}>
      <div className="px-8 pt-5">
        <Space
          direction="vertical"
          className="px-8 my-5 bg-gray-100 rounded-lg pt-5 pb-2 block sm:grid gap-x-3 border border-gray-200"
        >
          <Space direction="horizontal" className="pt-3">
            <Form.Item
              name="rangeDateChoice"
            ...
            <Form.Item
              name="rangeDate"
              initialValue={[dayjs('2000-01-01T00:00:00'), dayjs()]}
            >
              <DateRangeField />
            </Form.Item>
          </Space>
