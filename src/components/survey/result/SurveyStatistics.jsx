...
import DogResult from '/public/img/survey/dog.png';
import DogResultActive from '/public/img/survey/dog_red.png';

import { UnitOfDemicalPointOfOneMealGram } from '../../../../util/func/subscribe/finalVar';
import Image from 'next/image';
import { useSelector } from 'react-redux';
import DogTypeResult from './DogTypeResult';
        ...
        <div className={s.survey_result_wrapper}>
          <main className={`${s.grid_container_box} animation-show-all-child`}>
            ...
            <div className={s.grid_container}>
              ...
              <DogTypeResult
                info={info}
                dogInfo={dogInfoResults[isActiveDogIdx]}
              />
              <ScoreResult
                info={info}
                // dogInfo={dogInfoResults[isActiveDogIdx]}
