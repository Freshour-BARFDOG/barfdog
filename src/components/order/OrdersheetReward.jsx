        ...
        <div className={s.flex_box}>
          <div className={s.title_wrapper}>
            ...
            <span className={s.point}>
              <p>(보유</p> {transformLocalCurrency(info.reward) + ' P)'}
            </span>
          </div>
          ...
          <div className={s.input_box}>
            <div className={s['input-wrap']}>
              ...
              />
              {formErrors.discountReward && (
                <ErrorMessage>{formErrors.discountReward}</ErrorMessage>
              )}
            </div>
            <button
              type={'button'}
              className={s.btn_box}
              onClick={onClickDisCountReward}
            >
              모두 사용
            </button>
          </div>
