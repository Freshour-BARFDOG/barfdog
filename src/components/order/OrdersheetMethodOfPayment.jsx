...
export const OrdersheetMethodOfPayment = ({
  id,
  form,
  setForm,
  formErrors,
    ...
    <>
      <section className={s.method}>
        ...
        <ul className={s.grid_box}>
          {/* 1) 네이버 페이 */}
          <li
            className={`${s.inner_box} ${
              form[id] === paymentMethodType.NAVER_PAY ? s.selected : ''
            }`}
            data-payment-method={paymentMethodType.NAVER_PAY}
            onClick={onClickHandler}
            style={{ backgroundColor: 'rgb(3, 199, 90)' }}
          >
          ...
          <li
            className={`${s.inner_box} ${
              form[id] === paymentMethodType.KAKAO_PAY ? s.selected : ''
            }`}
            data-payment-method={paymentMethodType.KAKAO_PAY}
            onClick={onClickHandler}
            style={{
          ...
          <li
            className={`${s.inner_box} ${
              form[id] === paymentMethodType.CREDIT_CARD ? s.selected : ''
            }`}
            onClick={onClickHandler}
            data-payment-method={paymentMethodType.CREDIT_CARD}
          >
