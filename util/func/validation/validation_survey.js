...
const validate_surveyStep1 = (obj) => {
  ...
  for (const key of keys) {
    ...
    switch (key) {
      ...
      //   break;
      // case 'birth':
      //   errors[key] = valid_dogBirthYearAndMonth(val)
      //     ? '출생년월 ' + valid_dogBirthYearAndMonth(val)
      //     : '';
      //   break;
      ...
      //   errors[key] = valid_dogWeight(strVal)
      //     ? '몸무게 ' + valid_dogWeight(strVal)
      //     : '';
      //   break;
      // case 'neutralization':
      //   errors[key] = valid_isEmpty(val, { detail: true })
      //     ? '중성화 여부 ' + valid_isEmpty(val, { detail: true })
      //     : '';
      //   break;
    }
  }
...
//           ? '평균 산책횟수 ' + valid_isEmpty(val)
//           : '';
//         break;
//       case 'walkingTimePerOneTime':
//         errors[key] = valid_isEmpty(val)
//           ? '1회 당 산책시간 ' + valid_isEmpty(val)
//           : '';
//         break;
//       case 'dogStatus':
//         errors[key] = valid_isEmpty(val)
//           ? '반려견 상태 ' + valid_isEmpty(val)
//           : '';
//         break;
//     }
//   }
...
//         errors[key] = valid_isEmpty(val)
//           ? '못 먹는 음식의 기타 ' + valid_isEmpty(val)
//           : '';
//         break;
//       case 'recommendRecipeId':
//         errors[key] = valid_isEmpty(val)
//           ? '특별히 챙겨주고 싶은 부분 ' + valid_isEmpty(val)
//           : '';
//         break;
//       case 'caution':
//         errors[key] = valid_isEmpty(val)
//           ? '기타 특이사항(질병 등) ' + valid_isEmpty(val)
//           : '';
//         break;
//     }
//   }
...
//       case 'inedibleFood':
//         errors[key] = valid_isEmpty(val)
//           ? '못 먹는 음식 ' + valid_isEmpty(val) + ' 특정한 값을 선택해주세요.'
//           : '';
//         break;
//       case 'inedibleFoodEtc':
//         errors[key] = valid_isEmpty(val)
